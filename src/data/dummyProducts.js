const dummyProducts = [
    {
      ...
      "Product-description": "Grekiska solmogna finkrossade tomater med hög sötma och tydlig syra.",
    ...
    },
    {
      ...
      "Product-description": "Röda linser från GoGreen.",
    ...
    },
    {
      ...
      "Product-description": "Amore mio, dessa krossade tomater kan vara din nya bästis.",
    ...
    },
    {
      ...
      "Product-description": "Trocadero, som lanserades i Sverige i början av 50-talet.",
    ...
    },
    {
      ...
      "Product-description": "En singel wettex trasa i en läcker färg. Finns i 4 olika färger",
    ...
    },
    {
      ...
      "Product-description": "Toalettrullar som är mjuka och starka på samma gång. Ett test gjorde att rullarna tillverkades på två- istället för trelagerspapper.",
    ...
    },
    {
      ...
      "Product-description": "Ett skonsamt och parfymfritt tvättmedel som effektivt rengör färgade kläder utan att bleka eller skada tygerna. ",
    ...
    },
    {
      ...
      "Product-description": "Polly Tropical är tropisk mix av härligt sega skumtoppar med smak av persika, passionsfrukt och apelsin.",
      "Product-weight": "150 G",
    ...
    },
    {
      ...
      "Product-description": "Pändy Frosty Blueberry är ett sötsyrligt skumgodis med smak av blåbär.",
      "Product-weight": "50 g",
    ...
    },
    {
      ...
      "Product-description": "Ölkorv Hot Amigo är en eldig och kryddstark korv med en djärv chilismak.",
      "Product-weight": "20 g",
    ...
    },
    {
      ...
      "Product-description": "Klassiska Daim här i en ny spännande variant! ",
      "Product-weight": "56g",
    ...
    },
    {
      ...
      "Product-description": "Ahlgrens bilar Original är en självklar favorit bland godispåsar.",
